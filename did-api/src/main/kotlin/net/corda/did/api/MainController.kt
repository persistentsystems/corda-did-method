...
* */
    /**
     * @param[did] this is the unique decentralized identifier generated by the client application.
     * @return the raw DID document if found else returns 404.
     * */
     ...
     * @return a json response with a status code of 200 if delete operation was a success,404 if conflict, 400 due to any other error in the sent parameters.
     * */
