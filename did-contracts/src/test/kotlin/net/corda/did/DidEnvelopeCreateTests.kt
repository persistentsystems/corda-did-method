...
class DidEnvelopeCreateTests {
	...
	@Test
	fun `validation fails if publicKey controller is not equal to did`() {
		val document = """{
		|  "@context": "https://w3id.org/did/v1",
		|  "id": "did:corda:tcn:11f4e420-95dc-4969-91eb-4795883fa781",
		|  "created": "1970-01-01T00:00:00Z",
		...
		|	  "id": "did:corda:tcn:11f4e420-95dc-4969-91eb-4795883fa781#keys-1",
		|	  "type": "Ed25519VerificationKey2018",
		|	  "controller": "did:corda:tcn:11f4e420-95dc-496a-91eb-4795883fa781",
		|	  "publicKeyBase58": "GfHq2tTVk9z4eXgyTPxte7rrotCf1ueoXyJfRob7vTv9kGDhed6ESWnjLXav"
		|	}
		|  ]
		|}""".trimMargin()
		...
		assertThat(actual, isA<DidEnvelopeFailure.ValidationFailure.InvalidPublicKeyController>())
	}
}